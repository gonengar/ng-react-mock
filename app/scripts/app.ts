...
angular
  .module('ngReactmockAppInternal', ['ngReactmockTranslations', 'ngReactmockPreload', 'wixAngular', 'wix.common.bi', 'react']);
...
angular
  .module('ngReactmockApp', ['ngReactmockAppInternal', 'react'])
  .config(() => {
    return;
  });
